...
# Add a proper test endpoint that accepts GET requests
...
# Modify your webhook route to handle both GET and POST
@app.route('/', methods=['GET', 'POST'])
@app.route('/webhook', methods=['GET', 'POST'])
def webhook():
    logger.info(f"Webhook endpoint called with method: {request.method}")
